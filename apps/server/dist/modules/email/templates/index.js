...
exports.generateEnrollmentEmail = generateEnrollmentEmail;
exports.generatePaymentEmail = generatePaymentEmail;
exports.generateCourseUpdateEmail = generateCourseUpdateEmail;
...
function generateEnrollmentEmail(courseTitle) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
...
function generatePaymentEmail(name, amount, courseTitle, orderId) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
...
function generateCourseUpdateEmail(courseTitle, message) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
...
function generatePasswordResetEmail(name, otp) {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
