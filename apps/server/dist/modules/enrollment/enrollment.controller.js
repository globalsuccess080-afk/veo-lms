...
exports.check = exports.myEnrollments = void 0;
...
exports.check = [
    auth_middleware_1.authenticate,
    (0, asyncHandler_1.asyncHandler)(async (req, res) => {
        const data = await enrollmentService.checkEnrollment(req.user.id, (0, params_1.param)(req.params.courseId));
        (0, apiResponse_1.sendSuccess)(res, data);
    })
];
